...
class HD_BSNet_TwoStageDetector(BaseDetector):
    ...
    def forward(self,
        ...
        """
        if mode == 'loss':
            return self.loss(inputs, data_samples, src_inputs)
        elif mode == 'predict':
            return self.predict(inputs, data_samples, src_inputs)
        elif mode == 'tensor':
